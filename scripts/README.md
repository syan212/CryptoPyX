...
These are scripts for my convenience

benches.sh - runs benchmarks thrice, and compares them

install.sh -  Installs dev and doc dependencies and installs the actual package
